...
/*   Updated: 2026/09/08 15:29:17 by hal-lawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*  Phong model --> 3 components of light: ambient, diffuse, and specular.
  -------------------------------------------------------
- The (light intensity) represents the light amount and the light color 
  that is emitted from the light source.
- The (effective light) represent how the light color and the oject color
  interact with each other.
- The (ambient light) exist for every pixel in the sceene.
- The (diffuse and spectular) light is only calculated if the angle
  between the normal and the light is less than 90 degrees. If the 
  angle is greater than 90 degrees.
*/

t_color	lighting(t_material material, t_light light, t_ambient ambient,
		t_calculations calc)
{
