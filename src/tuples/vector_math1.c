...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/02 12:54:36 by hal-lawa          #+#    #+#             */
/*   Updated: 2026/09/08 16:24:47 by hal-lawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tuple	normalize_vector(t_tuple vector)
{
	...
	return (new_tuple(vector.x / magnituade, vector.y / magnituade, vector.z
			/ magnituade, vector.w / magnituade));
}
...
t_tuple	cross_product(t_tuple t1, t_tuple t2)
{
	...
	return (new_vector(t1.y * t2.z - t1.z * t2.y, t1.z * t2.x - t1.x * t2.z,
			t1.x * t2.y - t1.y * t2.x));
}
